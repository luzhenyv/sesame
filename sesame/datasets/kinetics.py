...
def _load_video(path):
    """
    Opens a video file，then load video stream.
    Args:
        path(string): path of a video file
    Returns:
        frames(numpy): decoded frames from the video, if success, else None
    """
...
class Kinetics(torch.utils.data.Dataset):
    ...
    def __init__(self, cfg, mode, num_retries=10):
        """
         Construct the Kinetics video loader with a given txt file. The format of
         the txt file is:
         ```
        ...
        log.info("Constructing Kinetics {}...".format(mode))
    ...
    def _construct_loader(self):
        ...
        assert os.path.exists(path_to_file), "{} file not found".format(
            path_to_file
        )
    ...
    def __getitem__(self, index):
        ...
        for i_try in range(self._num_retries):
            ...
            frames = _load_video(self._path_to_videos[index])
            ...
            if frames is None:
                ...
                if i_try > self._num_retries // 2:
                    ...
                    index = random.randint(0, int(index) - 1)
                continue
            ...
            frames = decoder.decode(
                ...
                self.cfg.DATA.USE_OFFSET_SAMPLING,
