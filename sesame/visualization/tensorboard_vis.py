...
from sesame.visualization.utils import get_confusion_matrix, \
...
class TensorboardWriter(object):
    ...
    def add_graph(self, model, inputs):
        """
        Add model compute graph to Tensorboard logs.
        Args:
            model (nn.module): the graph of model.
